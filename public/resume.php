...
$meta = [];
$meta['description'] = "Resume MicroTrain2108 For Web Development West Loop";
$meta['keywords'] = "resume, MicroTrain2108, Web development, web development, west loop";
    ...
    <main>
      <section class="intro">
        <h1>MicroTrain2108</h1>
          <div>
            <a href="https://microtrain2108.github.io" target="_blank" rel="noopener">GitHub</a>
            &#x25CF;
      ...
      <section class="edu">
        ...
        <span class="float-right">Summer 2021</span>
        </h3>
        ...
        <h3 class="clearfix">
          MicroTrain Technologies - Chicago, IL
        <span class="float-right">Fall 2021</span>
        </h3>
